...
def containers_remove_all():
    ...
    """
    output = docker('rm', '-f', '$(docker ps -aq)')
...
def images_remove_all():
    ...
    output = docker('rmi', '-f', '$(docker images)')

    resp = jsonify({removed_images, output})
    return Response(response=resp, mimetype="application/json")
...
def images_create():
    ...
    # create a web form for this one
